      ...
      <div className="flex flex-col w-full">
        ...
        >
          <div className="flex justify-between gap-2 items-center">
            ...
            <div className="flex items-center w-full gap-2">
              <p className="font-inter text-sm font-normal">Card Name:</p>
              <select className="bg-primary w-[160px] flex justify-center items-center font-inter outline-none p-1 rounded-lg">
                <option>none</option>
                <option>data</option>
              </select>
            </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="w-full rounded-lg flex items-center justify-between bg-white border border-primary p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    ></div>
                    <div
                      className="rounded-full size-5 bg-[#22c55e]"
                      onClick={() => handleSelectColor("#22c55e")}
                    ></div>
                    <div
                      className="rounded-full size-5 bg-[#f97316]"
                      onClick={() => handleSelectColor("#f97316")}
                    ></div>
                    <div
                      className="rounded-full size-5 bg-[#3b82f6]"
                      onClick={() => handleSelectColor("#3b82f6")}
                    ></div>
                    <div
                      className="rounded-full size-5 bg-[#a855f7]"
                ...
                <div className="w-full rounded-lg flex flex-col gap-2 bg-white border border-primary p-4">
                  <div className="border-b border-b-black pb-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="rounded-full size-5 bg-yellow-500"></div>
                      <div className="rounded-full size-5 bg-green-500"></div>
                      <div className="rounded-full size-5 bg-orange-500"></div>
                      <div className="rounded-full size-5 bg-blue-500"></div>
                      <div className="rounded-full size-5 bg-purple-500"></div>
