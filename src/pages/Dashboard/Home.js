  ...
  return (
    <section className="">
      ...
      <div className="grid gap-3 lg:grid-cols-3 grid-cols-1">
        {loading ? (
          <div className="bg-primary h-[300px] p-2 rounded-2xl relative flex flex-col justify-between animate-pulse">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              ...
              <div className="flex gap-2 items-center">
                <div className="w-24 h-8 bg-gray-300 rounded shimmer" />
                <div className="w-24 h-8 bg-gray-300 rounded shimmer" />
              </div>
            </div>
          </div>
